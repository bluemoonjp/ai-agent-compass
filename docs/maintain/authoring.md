...
| `generated-fresh` | yes |  | docs/maintain/authoring.md's generated check table, practices/index.md, and README.md's generated blocks must match what pnpm gen produces from checks.json and practices/*.md, since a hand-edited copy silently drifts from the source it claims to summarize. |
