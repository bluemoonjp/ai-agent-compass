...
_Generated from `practices/*.md` by `pnpm gen`; do not edit this block._ **10** active practices are indexed in [`practices/index.md`](practices/index.md), licensed under [CC BY 4.0](LICENSE-DOCS).
...
_`practices/*.md` から `pnpm gen` で生成。このブロックは編集しないこと。_ **10** 件の active な practice を [`practices/index.md`](practices/index.md) に索引化(ライセンス: [CC BY 4.0](LICENSE-DOCS))。
